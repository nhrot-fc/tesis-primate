...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/frontends.png}
    \caption{Los tres \emph{front-ends} de entrada del detector sobre la misma ventana: mel de potencia sin transformar, log-mel y PCEN.}
    \label{fig:frontends}
\end{figure}
