...
from services.google_drive import build_drive_service, download_all_from_path


def setup_data() -> None:
    if settings.DATA_DIR is None or settings.SECRETS_DIR is None or settings.DATA_ZIP_DIR is None:
        raise ValueError(
